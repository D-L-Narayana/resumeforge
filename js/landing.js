...
$('templateGrid').innerHTML=D.templates.map(function(t){return `<a class="card template reveal" href="builder.html" style="--acc:${t.accent}"><div class="thumb"><div class="tbar"></div><div class="tline" style="width:85%"></div><div class="tline" style="width:60%"></div><div class="tline" style="width:75%"></div><div class="tline" style="width:42%"></div><div class="tline" style="width:70%"></div></div><h3>${t.name}</h3><p>${t.desc}</p></a>`;}).join('');
